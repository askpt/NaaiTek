...
//Using this code: http://aspnetwebstack.codeplex.com/SourceControl/latest#src/System.Web.Helpers/Crypto.cs
    ...
    public static class Crypto
    {
        ...
        public static string Hash(byte[] input, string algorithm = "sha256")
        {
            ...
            using (HashAlgorithm alg = HashAlgorithm.Create(algorithm))
            {
                ...
                {
                    throw new InvalidOperationException(String.Format(CultureInfo.InvariantCulture, "Not Supported {0}", algorithm));
                }
            }
        }
