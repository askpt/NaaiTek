...
void drawScene()
{
	...
	*/
	...
	glPushMatrix();
		...
		// adding "purple" color to ALL shapes
		glColor3f(0.5f, 0.0f, 0.8f);

		// drawing trapezoid
		glBegin(GL_QUADS);
			// color BLENDING (alternate vertex with color)
			glColor3f(0.5f, 0.0f, 0.8f);
	...
	glPushMatrix();
		...
		// adding "green" color to the REMAINING shapes
	...
	glPushMatrix();
		...
		// adding color to the ONLY shape remaining
		glColor3f(0.0f, 0.65f, 0.65f);
